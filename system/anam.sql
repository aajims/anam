...
INSERT INTO `produksi` (`id_produksi`, `no_wco`, `no_dies`, `no_produk`, `qty`, `id_mesin`, `id_operator`, `target`, `jam`, `downtime`, `jam_pakai`, `qty_hasil`, `tgl_produksi`) VALUES
(1, 'REQ-2018050001', '223344555555', 'F-10001', '2300', 1, 1, '2500', '8', '10', '7', '', '2018-05-10');
...
--
ALTER TABLE `mesin`
  MODIFY `id_mesin` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
